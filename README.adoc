...
* Hello Security 
** [Spring Boot](https://github.com/spring-projects/spring-security-samples/tree/main/servlet/spring-boot/java/hello-security)
*** 
```bash
./gradlew :servlet:spring-boot:java:hello-security:tasks
./gradlew :servlet:spring-boot:java:hello-security:build
...
** [WebFlux](https://github.com/spring-projects/spring-security-samples/tree/main/reactive/webflux/java/hello-security)
** [WebFlux.fn](https://github.com/spring-projects/spring-security-samples/tree/main/reactive/webflux-fn/hello-security)
